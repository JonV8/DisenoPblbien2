...
public class TabSmartphones extends Fragment {
    ...
    List<Smartphone> items=new ArrayList<Smartphone>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recycler = view.findViewById(R.id.recicladorTelefonos);
        ...
        try {
            jsonBody.put("tipo_producto", "Smartphones");
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        for (int i = 0; i < productos.length(); i++) {
                            try {
                                ...
                                items.add(new Smartphone(row));
                                adapter = new AdaptadorTelefonos(items,getContext());
